...
<div id="main-div">
    <div>
        ...
        <a href="index.php?a=show" class="right-up-link" id="username">Login in</a>
        <a href="./index.php?a=showRegister" class="right-up-link" id="logout">Register</a>
    </div>
    <div>
        <br>
        ...
        <nav class="medium-nav">
            <a href="./index.php?a=showHomePageAfter" id="homepage" class="nav-link">HomePage</a>
            ...
            <a href="./index.php?a=personalSpace" class="nav-link">Upload</a>
        </nav>
    </div>
    <br><br>
    <div id="slide-up">
        ...
        <div id="slide-right">
            ...
            <span class="img-class">--</span>
            <br>
            <div id="hottest-frame">
                <?PHP
                    $i=0;
                    while($i<3)
                     { $row = $list->fetch_row();
                ?>
                <div style="width: 180px;display: inline-block"><a href="./index.php?a=showArtDetail&artid=<?=$row[12]?>"><img src="<?=$row[11]?>" alt="最热作品1" class="latest-work"></a></div>
                <div class="msg">
                    <span>Name: </span><?=$row[0]?><br>
                    <span>Artist: </span><?=$row[1]?><br>
                    <span>Price: </span>$<?=$row[2]?>&nbsp;&nbsp;&nbsp;&nbsp;
                    <span>Visits: </span><?=$row[3]?><br>
    ...
    <div id="slide-down">
        ...
        <div >
            ...
            ?>
            <div class="img-down">
                <a href="./index.php?a=showArtDetail&artid=<?=$row[12]?>"><img src="<?=$row[11]?>" class="hottest-work"></a>
                <br>
                <div class="msg">
                    <span>Name: </span><?=$row[0]?><br>
    ...
    <br>
    <img src="../../public/img/箭头.png" id="point">
    <br>
    <a href="index.php?a=show" id="login-in-down"><span id="sign-in">Sign in &nbsp;</span> to find more interesting things</a>
    <div id="foot">
        <br><br>
        <hr>
